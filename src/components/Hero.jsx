    ...
    <section id="inicio" className="min-h-screen flex items-center pt-24 px-8">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div className="fade-in-up">
          <h2 className="text-gold text-xs tracking-deco-xl mb-6 font-semibold uppercase" style={{ fontFamily: 'Montserrat, sans-serif' }}>Exclusividad &amp; Vanguardia</h2>
        ...
        <div className="relative fade-in-up" style={{ animationDelay: '0.4s' }}>
            <div className="tech-frame border-12 border-deep-black">
            ...
            <img
              ...
              className="w-full h-hero object-cover grayscale hover:grayscale-0 transition duration-1000 opacity-70 hover:opacity-100 scale-105"
            />
          </div>
        </div>
      </div>
