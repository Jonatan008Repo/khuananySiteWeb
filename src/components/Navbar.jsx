...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full z-50 bg-[#002d1a]/95 backdrop-blur-lg border-b border-[#D4AF37]/20">
      <div className="max-w-7xl mx-auto px-8 py-5 flex justify-between items-center">
        <div className="text-3xl font-bold gold-gradient deco-font tracking-tighter">KHUANANY</div>
        <div className="hidden md:flex space-x-10 uppercase text-[10px] tracking-[0.3em]">
